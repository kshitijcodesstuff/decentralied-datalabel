    ...
    if (image) {
        return (
          <Image
            ...
            src={image}
            alt="" // Add an empty alt text for decorative images or a meaningful description for content images
            width={384} // Set the desired width of the image
            height={216} // Set the desired height of the image
          />
        );
      }
